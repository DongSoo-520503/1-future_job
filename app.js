...
const jobData = JSON.parse(
  fs.readFileSync(path.join(__dirname, 'data', 'future_job_final_1980.json'), 'utf8')
);
...
app.post('/recommend', (req, res) => {
  ...
  candidates.sort(
    (a, b) => b.final_score - a.final_score || parseInt(a['연봉순위']) - parseInt(b['연봉순위'])
  );
...
추천직업: ${best['추천직업']}
연봉순위: ${period} ${country} 10대 유망 미래 직종 중 ${best['연봉순위']}위에 해당됩니다.
직업해설: ${best['직업해설']}
...
// ✅ 로컬/웹(Render 등) 공통: 환경변수 PORT를 우선 사용
